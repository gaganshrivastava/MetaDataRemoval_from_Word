...
public class Lambda_Handler_BackUp_v1 implements RequestHandler<JSONObject, Object> {
	...
	public JSONObject handleRequest(JSONObject event, Context arg1) {
		...
		if (event.get("detail-type") != null && ((String) event.get("detail-type")).equals("Scheduled Event")) {
			...
			try {
				keyName = "a0aa0f2c-da69-4420-b5ea-bcd06b93ffb1/1617646540564/a0aa0f2c-da69-4420-b5ea-bcd06b93ffb116176465405641.vnd.openxmlformats-officedocument.wordprocessingml.document";
				dstKey = keyName;
				main();
				keyName = "";
				dstKey = keyName;
